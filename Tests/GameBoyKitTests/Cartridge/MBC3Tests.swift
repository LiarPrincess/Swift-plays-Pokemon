...
class MBC3Tests: CartridgeTestCase {
  ...
  private func enableRam(cartridge: inout MBC3) {
    cartridge.writeRom(0x1000, value: 0xa)
  }

  private func disableRam(cartridge: inout MBC3) {
  ...
  func test_writeRom_selectRamBank_read() throws {
    ...
    // Select 2 bank
    cartridge.writeRom(0x5000, value: 1)
  ...
  private func createCartridge(romSize: CartridgeRomSize,
                               ...
                               romData: [UInt16: UInt8] = [:]) throws -> MBC3
  {
    let type: CartridgeType = ramSize.byteCount == 0 ? .mbc3 : .mbc3Ram
    ...
    return MBC3(header: header, rom: data, ram: nil)
  }
}
