...
public struct CartridgeType: CustomStringConvertible {
  ...
  internal init(headerValue: UInt8) throws {
    switch headerValue {
    // noMBC
    case CartridgeType.noMBC.headerValue:
      self = CartridgeType.noMBC
    case CartridgeType.noMBCRam.headerValue:
      self = CartridgeType.noMBCRam
    case CartridgeType.noMBCRamBattery.headerValue:
      self = CartridgeType.noMBCRamBattery

    // mbc1
    case CartridgeType.mbc1.headerValue:
      self = CartridgeType.mbc1
    case CartridgeType.mbc1Ram.headerValue:
      self = CartridgeType.mbc1Ram
    case CartridgeType.mbc1RamBattery.headerValue:
      self = CartridgeType.mbc1RamBattery

    // mbc2
    case CartridgeType.mbc2.headerValue:
      self = CartridgeType.mbc2
    case CartridgeType.mbc2Battery.headerValue:
      self = CartridgeType.mbc2Battery

    // mbc3
    case CartridgeType.mbc3.headerValue:
      self = CartridgeType.mbc3
    case CartridgeType.mbc3Ram.headerValue:
      self = CartridgeType.mbc3Ram
    case CartridgeType.mbc3RamBattery.headerValue:
      self = CartridgeType.mbc3RamBattery
    case CartridgeType.mbc3TimerBattery.headerValue:
      self = CartridgeType.mbc3TimerBattery
    case CartridgeType.mbc3TimerRamBattery.headerValue:
      self = CartridgeType.mbc3TimerRamBattery

    // mbc4
    case CartridgeType.mbc4.headerValue:
      self = CartridgeType.mbc4
    case CartridgeType.mbc4Ram.headerValue:
      self = CartridgeType.mbc4Ram
    case CartridgeType.mbc4RamBattery.headerValue:
      self = CartridgeType.mbc4RamBattery

    // mbc5
    case CartridgeType.mbc5.headerValue:
      self = CartridgeType.mbc5
    case CartridgeType.mbc5Ram.headerValue:
      self = CartridgeType.mbc5Ram
    case CartridgeType.mbc5RamBattery.headerValue:
      self = CartridgeType.mbc5RamBattery
    case CartridgeType.mbc5Rumble.headerValue:
      self = CartridgeType.mbc5Rumble
    case CartridgeType.mbc5RumbleRam.headerValue:
      self = CartridgeType.mbc5RumbleRam
    case CartridgeType.mbc5RumbleRamBattery.headerValue:
      self = CartridgeType.mbc5RumbleRamBattery

    // mbc6, mbc7, huc1, huc3
    case CartridgeType.mbc6.headerValue:
      self = CartridgeType.mbc6
    case CartridgeType.mbc7.headerValue:
      self = CartridgeType.mbc7
    case CartridgeType.huc1.headerValue:
      self = CartridgeType.huc1
    case CartridgeType.huc3.headerValue:
      self = CartridgeType.huc3

    default:
      throw CartridgeError.unknownType(headerValue)
    }
  }
}
